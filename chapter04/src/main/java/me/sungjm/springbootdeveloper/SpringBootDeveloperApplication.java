...
/*
    1. 테스트 코드 개념 익히기
        ...
        보통 테스트 코드 관련 공부는 본 개발 공부를 하느라 미루는 경우가 많은데, 좀 익숙해지면
            ...
            테스트 코드란?
                테스트 코드는 test 다렉토리에서 작업함 -> 프로젝트 생성시 src의 하위 폴더,
                ...
                ex) 새로운 메뉴를 저장하는 코드를 테스트한다고 가정했을 때의
                    ...
                    public void savedMenuTest() {
                        ...
                        // 2. when : 실제로 메뉴를 저장
                        final long savedId = menuSerivce.save(americano)
