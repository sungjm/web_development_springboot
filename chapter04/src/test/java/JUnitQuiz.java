...
// import static의 경우 종종 보게 될텐데 정적 매서드에 해당하는 것을 가져올 때 쓰입니다.
public class JUnitQuiz {
    ...
    public void junitTest2() {
        /*
            문제 02
                int로 선언한 변수 3개가 있습니다. number1, number2, number3는 각각 15, 0, -5
        ...
        //1
            assertThat(number1).isPositive(); // isNotPositive는 0을 포함
