package me.sungjm.springbootdeveloper.config;

import lombok.RequiredArgsConstructor;
import me.sungjm.springbootdeveloper.service.UserDetailService;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .formLogin(formLogin -> formLogin   // 4. 품 기반 로그인 설정
                        .loginPage("/login")
                ...
                .csrf(AbstractHttpConfigurer::disable)      // 6. csrf 설정 비활성화
                .build();
    }
...
/*
    ...
    회원 가입 구현
        서비스메서드 작성할겁니다 -> 사용자 정보를 담고 있는 객체를 만들 수 있도록 해야합니다.
